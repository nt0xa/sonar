...
func (c *Command) dnsRecordsCreate(cmd *cobra.Command) runFunc {
...
func (c *Command) dnsRecordsDelete(cmd *cobra.Command) runFunc {
...
func (c *Command) dnsRecordsList(cmd *cobra.Command) runFunc {
...
func (c *Command) dnsRecordsClear(cmd *cobra.Command) runFunc {
