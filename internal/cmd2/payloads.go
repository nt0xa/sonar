...
func (c *Command) payloadsCreate(cmd *cobra.Command) cmdx.RunFunc {
...
func (c *Command) payloadsList(cmd *cobra.Command) cmdx.RunFunc {
...
func (c *Command) payloadsUpdate(cmd *cobra.Command) cmdx.RunFunc {
	var (
...
func (c *Command) payloadsDelete(cmd *cobra.Command) cmdx.RunFunc {
...
func (c *Command) payloadsClear(cmd *cobra.Command) cmdx.RunFunc {
