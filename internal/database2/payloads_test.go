...
func TestPayloadsCreate_Success(t *testing.T) {
	...
	o, err := db.PayloadsCreate(t.Context(), database2.PayloadsCreateParams{
		UserID:          1,
...
func TestPayloadsCreate_Duplicate(t *testing.T) {
	...
	_, err := db.PayloadsCreate(t.Context(), database2.PayloadsCreateParams{
		UserID:    1,
		Subdomain: "8a8b58beaf",
		Name:      "payload1",
	})
...
func TestPayloadsFindByUserAndName_Success(t *testing.T) {
	...
	pp, err := db.PayloadsFindByUserAndName(t.Context(), database2.PayloadsFindByUserAndNameParams{
		UserID: 1,
		Name:   "%payload1%",
		Limit:  10,
		Offset: 0,
...
func TestPayloadsUpdate_Success(t *testing.T) {
	...
	updated, err := db.PayloadsUpdate(t.Context(), database2.PayloadsUpdateParams{
		ID:              o.ID,
		UserID:          o.UserID,
