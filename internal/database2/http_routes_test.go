...
func TestHTTPRoutesCreate_Success(t *testing.T) {
	...
	o, err := db.HTTPRoutesCreate(t.Context(), database2.HTTPRoutesCreateParams{
		PayloadID: 1,
		Method:    "GET",
		Path:      "/test",
		Code:      200,
...
func TestHTTPRoutesCreate_Duplicate(t *testing.T) {
	...
	_, err := db.HTTPRoutesCreate(t.Context(), database2.HTTPRoutesCreateParams{
		PayloadID: 1,
		Method:    "GET",
		Path:      "/get",
		Code:      200,
...
func TestHTTPRoutesUpdate_Success(t *testing.T) {
	...
	updated, err := db.HTTPRoutesUpdate(t.Context(), database2.HTTPRoutesUpdateParams{
		ID:        o.ID,
...
func TestHTTPRoutesGetByPayloadMethodAndPath(t *testing.T) {
	...
	o, err := db.HTTPRoutesGetByPayloadMethodAndPath(t.Context(), database2.HTTPRoutesGetByPayloadMethodAndPathParams{
		PayloadID: 1,
		Method:    "POST",
		Path:      "/post",
	})
	...
	// Not exist
	_, err = db.HTTPRoutesGetByPayloadMethodAndPath(t.Context(), database2.HTTPRoutesGetByPayloadMethodAndPathParams{
		PayloadID: 1337,
		Method:    "POST",
		Path:      "/post",
	})
