...
func (_m *Actions) AuditRecordsGet(_a0 context.Context, _a1 actions.AuditRecordsGetParams) (*actions.AuditRecordsGetResult, errors.Error) {
	...
	var r0 *actions.AuditRecordsGetResult
	var r1 errors.Error
	if rf, ok := ret.Get(0).(func(context.Context, actions.AuditRecordsGetParams) (*actions.AuditRecordsGetResult, errors.Error)); ok {
		return rf(_a0, _a1)
	}
	if rf, ok := ret.Get(0).(func(context.Context, actions.AuditRecordsGetParams) *actions.AuditRecordsGetResult); ok {
		r0 = rf(_a0, _a1)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*actions.AuditRecordsGetResult)
		}
	}

	if rf, ok := ret.Get(1).(func(context.Context, actions.AuditRecordsGetParams) errors.Error); ok {
		r1 = rf(_a0, _a1)
	} else {
		if ret.Get(1) != nil {
...
func (_m *Actions) AuditRecordsList(_a0 context.Context, _a1 actions.AuditRecordsListParams) (actions.AuditRecordsListResult, errors.Error) {
	ret := _m.Called(_a0, _a1)
	...
	var r0 actions.AuditRecordsListResult
	var r1 errors.Error
	if rf, ok := ret.Get(0).(func(context.Context, actions.AuditRecordsListParams) (actions.AuditRecordsListResult, errors.Error)); ok {
		return rf(_a0, _a1)
	}
	if rf, ok := ret.Get(0).(func(context.Context, actions.AuditRecordsListParams) actions.AuditRecordsListResult); ok {
		r0 = rf(_a0, _a1)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(actions.AuditRecordsListResult)
		}
	}

	if rf, ok := ret.Get(1).(func(context.Context, actions.AuditRecordsListParams) errors.Error); ok {
		r1 = rf(_a0, _a1)
	} else {
		if ret.Get(1) != nil {
			r1 = ret.Get(1).(errors.Error)
