...
func (c *Command) httpRoutesCreate(cmd *cobra.Command) runFunc {
	var (
...
func (c *Command) httpRoutesUpdate(cmd *cobra.Command) runFunc {
	var (
...
func (c *Command) httpRoutesDelete(cmd *cobra.Command) runFunc {
...
func (c *Command) httpRoutesList(cmd *cobra.Command) runFunc {
...
func (c *Command) httpRoutesClear(cmd *cobra.Command) runFunc {
